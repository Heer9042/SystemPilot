      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-bold text-slate-100 flex items-center gap-2">
            <HardDrive className="w-5 h-5 text-indigo-400" /> Storage Drives & Partitions
          </h2>
          <p className="text-xs text-slate-400">Logical volumes, drive health, and filesystem metrics</p>
        </div>
      </div>
          ...
          <Card key={idx} className="space-y-4">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-surface-800 text-brand-400 border border-slate-700/50">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs font-mono">
                <span className="text-slate-400">Used: {formatBytes(disk.used_space_bytes)}</span>
