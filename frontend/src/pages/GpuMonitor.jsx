      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-bold text-slate-100 flex items-center gap-2">
            <Tv className="w-5 h-5 text-indigo-400" /> GPU Monitoring & Adapters
          </h2>
          <p className="text-xs text-slate-400">Discrete and Integrated graphics hardware detection</p>
        </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="text-sm font-bold text-slate-100">{gpu.name}</h3>
            ...
            <div className="space-y-3 pt-2 border-t border-slate-800/80">
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-slate-400">Dedicated Video Memory (VRAM)</span>
              ...
              <div className="grid grid-cols-2 gap-2 pt-2">
                <div className="p-2.5 rounded-lg bg-surface-900 border border-slate-800">
                  <span className="text-[11px] text-slate-400 block">GPU Engine Load</span>
                ...
                <div className="p-2.5 rounded-lg bg-surface-900 border border-slate-800">
                  <span className="text-[11px] text-slate-400 block">Thermal Sensor</span>
