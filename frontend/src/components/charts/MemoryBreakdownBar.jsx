...
export function MemoryBreakdownBar({
  ...
  return (
    <div className="w-full flex flex-col gap-2">
      <div className="h-5 w-full rounded-xl overflow-hidden flex bg-slate-100 dark:bg-surface-900 border border-slate-300/80 dark:border-slate-700/40 p-0.5">
        <div
      ...
      <div className="flex flex-wrap items-center justify-between text-xs pt-1 font-mono">
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-500 dark:text-slate-400 font-sans">In Use:</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-500 dark:text-slate-400 font-sans">Standby / Cached:</span>
          <span className="font-semibold text-slate-800 dark:text-slate-200">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-500 dark:text-slate-400 font-sans">Free:</span>
          <span className="font-semibold text-slate-800 dark:text-slate-200">
